...
<div class="min-h-screen flex justify-between bg-gray-100">
  ...
  <div class="flex flex-col justify-between w-[80vw]">
    ...
    <main class="mx-auto pt-8 pb-16 px-20 bg-gray-100 w-full flex-1 flex justify-center  gap-10">
      <div class="">
        <h2 class="text-5xl font-semibold mb-8 uppercase text-center">À propos d'<span class="text-[#E28F20] font-extrabold">Évasion Camping</span></h2>
