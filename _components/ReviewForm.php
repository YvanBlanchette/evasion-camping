...
<form method="POST" action="/evasion-camping/_actions/act-create_review.php" class="my-10">
  <div class="flex flex-col md:flex-row justify-between items-center gap-4 md:gap-10 mb-4  px-0">
    <!-- Date -->
    ...
    <!-- Number of stars -->
    <div class="flex flex-col gap-1 w-full md:w-[40%] text-end">
  ...
  <div class="flex flex-col md:flex-row justify-between items-center gap-10 mb-4">
    <!-- Username -->
    <div class="flex flex-col gap-1 w-full">
      <label class="block text-end" for="username">Nom d'utilisateur<span class="text-red-500"> *</span></label>
      <input type="text" id="username" name="username" placeholder="ex: JohnSmith001" class="px-2 py-1" required minlength="5" maxlength="100">
    </div>
    <!-- Email -->
    <div class="flex flex-col gap-1 w-full">
      <label class="block text-end" for="email">Adresse courriel<span class="text-red-500"> *</span></label>
  ...
  <!-- Review -->
  <div class="flex flex-col gap-1 w-full">
    <label class=" text-end" for="review">Donnez-nous votre avis<span class="text-red-500"> *</span></label>
