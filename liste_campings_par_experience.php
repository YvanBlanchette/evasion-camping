...
<div class="min-h-screen w-[100vw] flex justify-between">
  ...
  <div class="flex flex-col justify-between w-[100vw] lg:w-[80vw]">
    ...
    <main class="flex-1 py-12 px-[5vw] bg-gray-100">
      ...
      <h1 class="text-lg md:text-3xl uppercase text-center mb-4">Campings par expérience: <span class="text-[#E28F20] font-bold"><?= $experience_name ?></span></h1>

      <!-- Experience Description -->
      <p class="text-sm md:text-base text-center mb-6 w-[90%] mx-auto"><?= $experience_description ?></p>
          ...
          <?php foreach ($campings as $camping) { ?>
            <li>
              <div class="min-h-[200px] rounded-md bg-white shadow-xl flex flex-col md:flex-row">
                ...
                <!-- DETAILS -->
                <div class="md:w-3/4 px-6 pt-2 pb-4 flex flex-col">
                  <h4 class="text-lg text-center md:text-start md:text-3xl"><?= $camping['name'] ?></h4>
                  <!-- REGION/RATING -->
