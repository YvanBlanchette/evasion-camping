      ...
      <div class="flex flex-col lg:flex-row justify-evenly gap-y-4 my-6">
        ...
        <div class="text-center">
          ...
          <ul class="mb-4 space-y-2">
            ...
            <li class="text-lg"><a href="tel:123-456-7890" class="text-lg hover:text-[#E28F20] transition-all duration-300 flex justify-center lg:justify-start items-center gap-2"><i class="fa-solid fa-phone text-sm"></i>(123) 456-7890</a></li>
            <li class="text-lg"><a href="mailto:info@evasioncamping.com" class="text-lg hover:text-[#E28F20] transition-all duration-300 flex justify-center lg:justify-start items-center gap-2"><i class="fa-solid fa-envelope text-sm"></i>info@evasioncamping.com</a></li>
          </ul>
